...
UpSetR::upset(baseline_meta_df_mmse, sets= rev(med_cols), 
              # keep.order = TRUE,
      queries = list(
        list(query = elements, 
...
upset(overall_meta_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      queries = list(
        list(query = elements, 
             params = list("dataset", c("AIBL","HABS", "NACC")), color = "#92A5D1", active = T, query.name = "AIBL"),
...
upset(baseline_meta_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      queries = list(
        list(query = elements, 
             params = list("dataset", c("AIBL","HABS", "NACC")), color = "#92A5D1", active = T, query.name = "AIBL"),
...
upset(overall_meta_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      queries = list(
        list(query = elements, 
             params = list("dataset", c("AIBL","HABS", "NACC")), color = "#92A5D1", active = T, query.name = "AIBL"),
...
upset(baseline_AIBL_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_AIBL_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(baseline_AIBL_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_AIBL_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(baseline_NACC_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_NACC_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(baseline_NACC_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_NACC_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(baseline_HABS_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_HABS_df_mmse, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(baseline_HABS_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
...
upset(overall_HABS_df_cdr, sets= rev(med_cols), 
      # keep.order = TRUE,
      nintersects = 30, 
      order.by = "freq",
      empty.intersections = "on",
