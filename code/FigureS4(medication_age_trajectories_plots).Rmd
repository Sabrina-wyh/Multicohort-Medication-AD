...
```{r}
NACC_full_df_cdr_imputed<-read.csv("../preprocessed_data/NACC/NACC_cdr_imputed_binary_consist.csv")
AIBL_full_df_cdr_imputed<-read.csv("../preprocessed_data/AIBL/AIBL_cdr_imputed_binary_consist.csv")
HABS_full_df_cdr_imputed<-read.csv("../preprocessed_data/HABSHD/HABSHD_cdr_imputed_binary_consist.csv")
...
ggplot2::ggsave("../plots/trajectory/CDR_age_prevalence_overall.png", p_age_cdr, width=12, height=4, device="png", dpi=600)
print(p_age_cdr)
```
