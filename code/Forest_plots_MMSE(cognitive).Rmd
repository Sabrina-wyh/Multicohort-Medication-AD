...
```{r}
NACC_hc= split_by_baseline(NACC_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$HC
AIBL_hc= split_by_baseline(AIBL_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$HC
HABS_hc= split_by_baseline(HABS_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$HC
```
...
# MCI
```{r}
NACC_mci= split_by_baseline(NACC_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$MCI
AIBL_mci= split_by_baseline(AIBL_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$MCI
HABS_mci= split_by_baseline(HABS_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$MCI
```
...
# AD
```{r}
NACC_ad= split_by_baseline(NACC_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$AD
AIBL_ad= split_by_baseline(AIBL_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$AD
HABS_ad= split_by_baseline(HABS_full_df_mmse, id_col = "id", visit_col = "visit_no", status_col = "status")$AD
```
...
plot_forest_subset(
  ...
  title        = "",
  filename     = "../plots/forestplot/MMSE_forestplot_cognition.pdf",
  width        = 15,
  height       = 20,

  # layout / styling
  ref_line     = 0,
  xlim_fixed   = c(-2.3, 2.3),
